        ...
        <div className="grid grid-cols-12">
          <motion.div {...leftAnimation} className="lg:col-span-5 col-span-12">
            <div className="flex gap-6 items-center lg:justify-start justify-center mb-5 mt-24">
              <Image
                src= {`${getImagePrefix()}images/icons/icon-bag.png`}
                alt="icon"
                width={100}
                height={100}
              />
              <p className="text-white sm:text-28 text-18 mb-0">
                Secure & Transparent Crypto for <span className="text-primary">Muslim</span> Project
              </p>
            </div>
            <h1 className="font-medium lg:text-46 md:text-40 text-24 lg:text-start text-center text-white mb-10">
              Muslim Token <span className="text-primary">(MUS)</span> was created to support{" "}
              <span className="text-primary">Muslim</span><span> projects and charity</span>!
            </h1>
...
>
  View Tokenomics
               ...
               <a
  href="https://pancakeswap.finance/swap" // сюда вставь нужную ссылку
  target="_blank"
