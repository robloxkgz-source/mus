  ...
  const services = [
    {
      ...
      text: "Guaranteed transparency and trust",
    },
    {
      icon: "/images/icons/icon-blockchain.svg",
      text: "Strong tokenomics & long-term vision",
    },
    {
      icon: "/images/icons/icon-Services.svg",
      text: "Driven by people, built for success.",
    },
  ];
        ...
        <div ref={ref} className="grid grid-cols-12 items-center">
          ...
          >
            ...
            <p className="sm:text-28 text-18 text-white">
              With <span className="text-primary">$MUS</span>, your investment is backed by real use cases, strong community, and long-term vision.
